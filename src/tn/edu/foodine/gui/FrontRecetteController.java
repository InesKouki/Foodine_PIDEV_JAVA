...
public class FrontRecetteController implements Initializable {
    ...
    String up = "C:/Users/azizm/Desktop/SEM2/PIDEV/Foodine_PIDEV/public/uploads/";
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            for (Recette event : list) {
                ...
                fxmlLoader.setLocation(getClass().getResource("RecetteItem.fxml"));
                AnchorPane itemBox = fxmlLoader.load();
                RecetteItemController itemController = fxmlLoader.getController();
